...
public class RefTypes : MonoBehaviour
{
    ...
    void RefGameMethod()
    {
        GameEntry.LubanTable.LoadLubanTable<BaseLubanTables>(null,null);
        GameEntry.LubanTable.TryGetTables<BaseLubanTables>(out BaseLubanTables tables);
        GameEntry.LubanTable.GetTables<BaseLubanTables>();
    }
}
